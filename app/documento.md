...
Mesma stack da referencia `site_midia5d` para reproduzir com fidelidade visual, estrutura de paginas,
navegacao, componentes, animacoes e comportamento responsivo — trocando integralmente a identidade e as
informacoes comerciais da Midia 5D pelas da **Papagaios Solutions IA** (ver mockup em `../visual/`).
